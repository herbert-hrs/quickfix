...
namespace QuickFix
{
    ...
    public class Session : IDisposable
    {
        ...
        public bool GenerateLogout(string text, char rejCode)
        {
            return GenerateLogout(null, text, rejCode);
        }
        /// <summary>
        /// Send a Logout message
        /// </summary>
        ...
        /// <returns></returns>
        private bool GenerateLogout(Message other, string text, char rejCode = ' ')
        {
            ...
            if(rejCode != ' ')
                logout.Header.SetField(new LogonRejCode (rejCode));
