...
namespace QuickFix
{
    ...
    public class SocketSettings : ICloneable
    {
        ...
        /// <summary>
        /// Sets a timeout in miliseconds for the completion of the ssl handshake.
        /// </summary>
        public int SSLHandshakeTimeout { get; set; } = 0;

        /// <summary>
        /// Sets a maximum number of allowed connections.
        /// </summary>
        ...
        public void Configure(QuickFix.Dictionary dictionary)
        {
            ...
            if (dictionary.Has(SessionSettings.SSL_HANDSHAKE_TIMEOUT))
                SSLHandshakeTimeout = dictionary.GetInt(SessionSettings.SSL_HANDSHAKE_TIMEOUT);

            if (dictionary.Has(SessionSettings.MAX_CONNECTIONS))
                MaxConnections = dictionary.GetInt(SessionSettings.MAX_CONNECTIONS);
