...
namespace QuickFix
{
    internal class AcceptorSocketDescriptor
    {
        ...
        public AcceptorSocketDescriptor(IApplication app, IPEndPoint socketEndPoint, SocketSettings socketSettings, QuickFix.Dictionary sessionDict)
        {
            socketEndPoint_ = socketEndPoint;
            socketReactor_ = new ThreadedSocketReactor(app, socketEndPoint_, socketSettings, sessionDict, this);
        }
