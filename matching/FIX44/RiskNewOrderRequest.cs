...
namespace QuickFix
{
    namespace FIX44 
    {
        public class RiskNewOrderRequest : Message
        {
            public const string MsgType = "U407";

            public RiskNewOrderRequest() : base()
            {
                this.Header.SetField(new QuickFix.Fields.MsgType("U407"));
            }
